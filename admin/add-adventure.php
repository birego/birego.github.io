                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Ajouter une aventure</h5>
                                            <p class="m-b-0">Utilisez cette section pour ajouter des aventures</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">Ajouter une aventure</a>
                                            </li>
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        <div class="pcoded-inner-content">
                                            ...
                                            <div class="card-header">
                                                ...
                                                <div class="card-header-right">
                                                    <a href="next-adventures">
                                                        <button type="button" class="btn btn-primary"> prochaines aventures <i class="fas fa-arrow-right text-white"></i></button>
                                                    </a>
                                                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="inputEmail4">Titre de la l'aventure</label>
