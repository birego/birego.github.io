                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <div class="card-header-right">
                                                    <a href="add-discoveries">
                                                        <button type="button" class="btn btn-primary"><i class="fas fa-plus text-white"></i> Nouvelle découverte</button>
                                                    </a>
                                                </div>
                                                                ...
                                                                <div class="accordion-content accordion-desc">
                                                                    ...
                                                                    <div class="row mt-2">
                                                                        <div class="col-md-4">
                                                                            <div class="row px-2">
                                                                                <div class="col-md-12">
                                                                                    <img src="../img/bg-img/image_1.webp" style="width:100%;min-width: 100px;">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                            ...
                                                            <div class="accordion-content accordion-desc">
                                                                ...
                                                                <div class="row mt-2">
                                                                        <div class="col-md-4">
                                                                            <div class="row px-2">
                                                                                <div class="col-md-12">
                                                                                    <img src="../img/bg-img/image_4.webp" style="width:100%;min-width: 100px;">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="row px-2">
                                                                                <div class="col-md-12">
                                                                                    <img src="../img/bg-img/6.webp" style="width:100%;">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <div class="accordion-content accordion-desc">
                                                            ...
                                                            <div class="row mt-2">
                                                                        <div class="col-md-4">
                                                                            <div class="row px-2">
                                                                                <div class="col-md-12">
                                                                                    <img src="../img/bg-img/image_7.webp" style="width:100%;min-width: 100px;">
                                                                                </div>
                                                                            </div>
                                                                        </div>
