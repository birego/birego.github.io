...
$sql = "SELECT * FROM discoveries ORDER BY id DESC LIMIT $offset, $discoveries_per_page";
$result = $conn->query($sql);
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="breadcrumb-content text-center">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Plus de découvertes</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            ?>
             <div class="row">
                <div class="col-12 col-lg-12">
                    ...
                    <h4 class="text-center mb-3" style="color: red;font-weight: bolder;"><?php echo ucfirst($row['start_date'])." - ".$row['end_date']; ?></h4>
                        ...
                        <ul class="pagination justify-content-center">
                            ...
                            <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                                <li class="page-item <?php if ($i == $current_page) echo 'active'; ?>">
                                    <a class="page-link bg-danger" href="?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                                </li>
                            <?php endfor; ?>
                            
                            <?php if ($current_page < $total_pages): ?>
                                <li class="page-item"><a class="page-link bg-danger" href="?page=<?php echo $current_page + 1; ?>">Suivant</a></li>
                            <?php endif; ?>
                        </ul>
                    </nav>
                </div>
