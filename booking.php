        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 col-lg-12">
                    <h2 class="contact-title mb-30 text-center"></h2>
                    <p class="mb-3"></p>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-12">
                    ...
                    <div class="alime-projects-menu">
                        <div class="portfolio-menu text-center">
                            <button class="btn active" data-filter="*" id="link" style="font-weight: 100;">Tous les voyages</button>
                            <button class="btn mt-2" data-filter=".decouvertes" style="font-weight: 100;">Découvertes</button>
                            <button class="btn mt-2" data-filter=".aventures" style="font-weight: 100;">Aventures et Activités</button>
                            <button class="btn mt-2" data-filter=".cultures" style="font-weight: 100;">Cultures</button>
                            <button class="btn mt-2" data-filter=".D" style="font-weight: 100;">Voyages</button>
            ...
            <div class="row alime-portfolio">
                ...
                <div class="row mt-2 px-2 py-2">
                    ...
                    $chaine_a_supprimer = "../../";
                    $sql = "SELECT * FROM discoveries order by id DESC";
                    $result = $conn->query($sql);
                    ...
                    ?>
                            <a href="">
                                <div class="col-md-12 single_gallery_item decouvertes mb-30 wow fadeInUp" data-wow-delay="100ms">
                                <div class="single-portfolio-content">
                                   <div class="list-group">
  <a href="#" class="list-group-item list-group-item-action">
    <div class="d-flex w-100 justify-content-between">
      <h5 class="mb-1" style="font-size: 130%"><?php echo ucfirst($row['title'])."-".$row['place']; ?></h5>
      <small class="text-danger" style="font-weight: bolder;"><?php
    ...
    <small><?php echo $row['details']; ?></small>
                ...
                <div class="row mt-2 px-2 py-2">
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                    ?>
                            <div class="col-md-12 single_gallery_item aventures mb-30 wow fadeInUp" data-wow-delay="100ms">
                                <div class="single-portfolio-content">
                                   <div class="list-group">
  <a href="#" class="list-group-item list-group-item-action">
    <div class="d-flex w-100 justify-content-between">
